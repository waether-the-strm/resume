...
export const Toggle = () => {
  ...
  return (
    ...
    >
      ...
      <span className="pointer-events-none relative inline-block h-5 w-5 transform rounded-full bg-amber-200/80 shadow ring-0 transition duration-200 ease-in-out group-data-[checked]:translate-x-5">
        <span
          aria-hidden="false"
        ...
        >
          <svg
            fill="none"
            viewBox="0 0 12 12"
            className="h-3 w-3 text-slate-950/70"
          >
            <path
        ...
        >
          <svg
            fill="currentColor"
            viewBox="0 0 12 12"
            className="h-3 w-3 text-slate-600/70"
          >

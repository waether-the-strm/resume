export const classes = {
  h1: " text-3xl lg:-ml-10 text-white/90 font-bold leading-8 mb-5 print:text-slate-900 ",
  h2: " text-2xl lg:-ml-10 lowercase text-gray-300 pb-2 mb-6 print:mb-0 print:text-slate-900 ",
